...
async function name(params) {
  ...
  try {
    const res = await axios.post(URLS.AddBookings, testData, {
...
name()
  const Get = () => {
    var token = datas
    axios
      .post("https://api.carnivalcastle.com/v1/carnivalApi/admin/booking/confirmedbookings",
    //   .post(URLS.GetPendingBookings,
        {},
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      ...
      .then(res => {
        ...
        setuserInCsv(res.data.confirmedBookingExcell)
  ...
  const custsearch = e => {
    ...
    const token = datas
    axios
      .post("https://api.carnivalcastle.com/v1/carnivalApi/admin/booking/confirmedbookings?searchQuery=" + `${e.target.value}`,
    //   .post(URLS.GetPendingBookingsSearch + `${e.target.value}`,
        {},
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const handleCategoryChange = (event) => {
    ...
    axios
      .post(URLS.GetSelectProducts,dataArray,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      )
      ...
      <div className="page-content">
        <div className="container-fluid">
          <Breadcrumbs
            ...
            breadcrumbItem="Confirmed Bookings"
          />
          {filter ? (
            <>
              <Card>

...
function DigitalBrochure() {
  ...
  const GetAllBroucher = () => {
    ...
    axios
      ...
      .then(res => {
        setform(res.data.highlight)
        setforms(res.data.highlight)
        setInputList(res.data.highlight.features)
      })
  }
  ...
  const changstatus = () => {
    ...
    axios
      .put(URLS.UpdatHighlights, dataArray, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(
        res => {
            ...
            <Col md={12}>
              <Card>
                <CardBody>
                  ...
                  >
                    <Row>
                      <CardTitle className="mb-3">Edit Highlights</CardTitle>
                      <Col md={8}>

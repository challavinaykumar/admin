                  ...
                  <Col lg="6" className="mt-4">
                    ...
                    <Row>
                      ...
                      <Col>
                        <div className="mb-3">
                          <Label for="basicpill-firstname-input1">
                            Ond and Half Hour <span className="text-danger">*</span>
                          </Label>
                          <Input
                            type="number"
                            className="form-control"
                            id="basicpill-firstname-input1"
                            placeholder="Enter Ond and Half Hour"
                            required
                    ...
                    <Row>
                      ...
                      {form.extraPerson == "Yes" ? (
                        <>
                          ...
                          {/* one and hour extra perion price */}
                        ...
                        >
                          ...
                          {/* <span>
                            <span className="text-danger ">
                              {" "}
                              {"Note: Upload Multi Images max-5 images"}
                            </span>
                          </span> */}
                        </div>
                      </div>
